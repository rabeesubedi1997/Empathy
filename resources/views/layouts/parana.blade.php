    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <aside class="w-64 flex-shrink-0 glass border-r border-white/5 flex flex-col" style="background: rgba(10,10,15,0.9);">
            ...
            <nav class="flex-1 p-4 space-y-6 overflow-y-auto">
                <!-- Primary Nav -->
                <div class="space-y-1">
                    <p class="text-gray-600 text-[9px] uppercase tracking-widest px-3 mb-3">Main</p>
                    <a href="{{ route('dashboard') }}" class="sidebar-item {{ request()->routeIs('dashboard') ? 'active' : '' }} flex items-center gap-3 px-3 py-2.5 rounded-lg text-gray-400 text-sm hover:text-white transition-colors">
                        <span>📊</span> Dashboard
                    </a>
                    <a href="{{ route('patients.index') }}" class="sidebar-item {{ request()->routeIs('patients.*') ? 'active' : '' }} flex items-center gap-3 px-3 py-2.5 rounded-lg text-gray-400 text-sm hover:text-white transition-colors">
                        <span>👥</span> Patients
                    </a>
                </div>
                ...
                <!-- Actions -->
                <div class="space-y-1">
                    <p class="text-gray-600 text-[9px] uppercase tracking-widest px-3 mb-3">Actions</p>
                    <a href="{{ route('patients.create') }}" class="sidebar-item flex items-center gap-3 px-3 py-2.5 rounded-lg text-gray-400 text-sm hover:text-white hover:bg-amber-400/10 transition-colors">
                        <span class="text-base">➕</span> Register Patient
                    </a>
                </div>
                ...
                <div class="space-y-1">
                    ...
                    <a href="{{ route('dashboard') }}#stats" class="sidebar-item flex items-center gap-3 px-3 py-2.5 rounded-lg text-gray-400 text-sm hover:text-white transition-colors">
                        <span>📈</span> Analytics
                    </a>
                    <a href="#settings" class="sidebar-item flex items-center gap-3 px-3 py-2.5 rounded-lg text-gray-400 text-sm hover:text-white transition-colors">
